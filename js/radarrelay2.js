...
module.exports = class radarrelay2 extends Exchange {
    describe() {
    ...
    async fetchMarkets() {
        ...
        for (let i = 0, len = records.length; i < len; i++) {
            ...
            const tokenA = radarrelay2.decodeTokenInfo(assetDataA.assetData);
            const tokenB = radarrelay2.decodeTokenInfo(assetDataB.assetData);
            if (tokenA && tokenB) {
